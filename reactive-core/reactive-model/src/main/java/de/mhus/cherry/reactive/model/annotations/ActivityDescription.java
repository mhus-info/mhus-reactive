...
public @interface ActivityDescription {
	...
	/**
	 * Define a list of outputs in case of start or parallel gateway the will be executed in parallel otherwise
	 * one of the is selected to execute. Set a default (without name) output at least.
	 * 
	...
	/**
	 * Set displayed names for the indexes (max 10). This can be
	 * overwritten by i18n.
	 * 
	 * @return Index names
	 */
