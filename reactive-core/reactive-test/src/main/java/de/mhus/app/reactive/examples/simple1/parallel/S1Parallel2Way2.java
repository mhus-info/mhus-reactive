 ...
 */
package de.mhus.app.reactive.examples.simple1.parallel;
...
@ActivityDescription(outputs = @Output(activity = S1GatewayJoin.class))
public class S1Parallel2Way2 extends RServiceTask<S1Pool> {
