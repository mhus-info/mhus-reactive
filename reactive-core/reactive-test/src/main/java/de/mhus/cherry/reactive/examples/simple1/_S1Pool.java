...
public class _S1Pool extends ConstBase {
  ...
  public static final Identifier PROJECT_VERSION = new Identifier(Identifier.TYPE.MAVEN, de.mhus.cherry.reactive.examples.simple1.S1Pool.class,"7.0.0-SNAPSHOT");
