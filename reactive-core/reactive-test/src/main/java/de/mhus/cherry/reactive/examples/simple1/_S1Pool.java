...
public class _S1Pool extends ConstBase {
  ...
  public static final Identifier PROJECT_VERSION = new Identifier(Identifier.TYPE.MAVEN, de.mhus.cherry.reactive.examples.simple1.S1Pool.class,"1.6.0");
  ...
  public static final Identifier _TEXT2 = new Identifier(Identifier.TYPE.GETTER, de.mhus.cherry.reactive.examples.simple1.S1Pool.class,"Text2");
