...
public class _S1Pool extends ConstBase {
  ...
  public static final Identifier PROJECT_VERSION = new Identifier(Identifier.TYPE.MAVEN, de.mhus.cherry.reactive.examples.simple1.S1Pool.class,"7.1.0-SNAPSHOT");
  ...
  public static final Identifier _CHECK_START_CASE = new Identifier(Identifier.TYPE.ACTION, de.mhus.cherry.reactive.examples.simple1.S1Pool.class,"checkStartCase");
