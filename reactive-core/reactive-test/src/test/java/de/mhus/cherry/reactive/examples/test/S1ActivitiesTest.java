...
public class S1ActivitiesTest {
    ...
    public void testSubStart() throws Exception {
        ...
        try { // exclusive kirk
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=substart&text2=kirk";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
    ...
    public void testParallel2() throws Exception {
        ...
        try { // step parallel
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=parallel2";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testParallel1() throws Exception {
        ...
        try { // step second
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=parallel1";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testTriggerTimer() throws Exception {
        ...
        try {
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=triggertimer";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testTriggerMessage() throws Exception {
        ...
        try {
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=trigger";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testSecond() throws Exception {
        ...
        try { // step second
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=second";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testThird() throws Exception {
        ...
        try { // step third
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=third";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testError1() throws Exception {
        ...
        try { // error1
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=error1";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testFatal() throws Exception {
        ...
        try { // fatal
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=fatal";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testNone() throws Exception {
        ...
        try { // none - try stopped after retry
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=none";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testStartpoint() throws Exception {
        ...
        try { // custom startpoint
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool#de.mhus.cherry.reactive.examples.simple1.S1Start2";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testExternal() throws Exception {
        ...
        try { // fire external
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=external";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId = engine.start(uri);
    ...
    public void testSignal() throws Exception {
        ...
        try { // fire signal
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=signal";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId1 = engine.start(uri);
    ...
    public void testMessage() throws Exception {
        ...
        try { // fire message
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=message";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId1 = engine.start(uri);
    ...
    public void testExclusiveGateway() throws Exception {
        ...
        try { // exclusive kirk
            ...
            mockup.setVerbose(false);
            String uri =
                    "bpm://de.mhus.cherry.reactive.examples.simple1.S1Process:0.0.1/de.mhus.cherry.reactive.examples.simple1.S1Pool?text1=exclusive&text2=kirk";
            System.out.println("URI: " + uri);
            System.out.println(
                    "------------------------------------------------------------------------");
            UUID caseId1 = engine.start(uri);
